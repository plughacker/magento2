...
use PlugHacker\PlugPagamentos\Api\CardsRepositoryInterface;
use PlugHacker\PlugPagamentos\Api\Data\CardsSearchResultsInterfaceFactory;
use PlugHacker\PlugPagamentos\Api\Data\CardsInterfaceFactory;
...
use PlugHacker\PlugPagamentos\Model\ResourceModel\Cards as ResourceCards;
use PlugHacker\PlugPagamentos\Model\ResourceModel\Cards\CollectionFactory as CardsCollectionFactory;
        ...
        if (!$cards->getId()) {
            ...
            if (isset($matchIds[0])) {
                ...
                if ($savedCard !== null) {
                    ...
                    $cards->setCardToken($savedCard->getPlugId()->getValue());
