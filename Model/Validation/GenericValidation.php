...
namespace PlugHacker\PlugPagamentos\Model\Validation;
    ...
    protected function verifyScopeAndValue($storeConfig)
    {
        ...
        if (
            ...
            $comment = $i18n->getDashboard(
                "Plug module should be configured on Websites scope, please change to website scope to apply these changes"
            );
