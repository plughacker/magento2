<?php
namespace PlugHacker\PlugPagamentos\Model\Ui\CreditCard;
        ...
        if ($this->getCustomerSession()->isLoggedIn()) {
            ...
            if ($customer !== null) {
                ...
                foreach ($coreCards as $coreCard) {
                    $is_saved_card = 1;
                    $selectedCard = 'plug_core_' . $coreCard->getId();
