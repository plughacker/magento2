...
use PlugHacker\PlugPagamentos\Api\BulkApiInterface;
use PlugHacker\PlugPagamentos\Concrete\Magento2CoreSetup;
use PlugHacker\PlugPagamentos\Factories\BulkSingleResponseFactory;
...
class Bulk implements BulkApiInterface
{
    ...
    private function getApiBaseUrl(): string
    {
        ...
        return $this->baseUrl . "rest/{$defaultStoreViewCode}/V1/plug";
    }
