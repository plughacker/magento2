...
use PlugHacker\PlugCore\Recurrence\Services\SubProductService;
...
class ProductPlanHelper
{
    ...
    public static function mapperProductPlanUpdate(
        ...
        $productPlan->setPlugId($planOriginal->getPlugId());
    ...
    public static function mapperProductPlan(ProductPlanInterface $productPlan) {
        ...
        foreach ($productPlan->getItems() as $subProduct) {
            ...
            if (!empty($subProductSaved)) {
                $subProduct->setPlugId($subProductSaved->getPlugId());
     ...
     * @param $planId
     * @param $productId
     * @return \PlugHacker\PlugCore\Kernel\ValueObjects\AbstractValidString|null
     */
