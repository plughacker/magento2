...
namespace PlugHacker\PlugPagamentos\Block\Adminhtml\Recurrence\Subscriptions;
...
use PlugHacker\PlugPagamentos\Ui\Component\Column\Invoices\Actions;
use PlugHacker\PlugPagamentos\Ui\Component\Recurrence\Column\TotalCyclesByProduct;
...
class Subscription extends Template
{
    ...
    const URL_PATH_DELETE = 'plug/invoices/delete';
    const URL_PATH_CANCEL_SUBSCRIPTION = 'plug/subscriptions/delete/id';
