var PlugFormHandler = function () {
    formObject = {}
};

PlugFormHandler.prototype.init = function (formObject) {
    this.formObject = formObject;
};

PlugFormHandler.prototype.switchBrand = function (brand) {
    ...
    if (typeof brand != 'undefined' && brand.length > 0) {
        var brandSelector = this.formObject.containerSelector + ' .' + brand.toLowerCase();
...
PlugFormHandler.prototype.updateInstallmentSelect = function (installmentsObj, element, installmentSelected = null) {
    var content = "";
...
PlugFormHandler.prototype.fillBrandList = function (brandsObject, formObject) {
    var html = '';
...
PlugFormHandler.prototype.hideInputAmount = function () {
    jQuery(this.formObject.containerSelector).find('.amount').hide();
};

PlugFormHandler.prototype.removeInstallmentsSelect = function () {
    jQuery(this.formObject.containerSelector).find('.installments').remove();
}

PlugFormHandler.prototype.removeSavedCardsSelect = function (form) {
    jQuery(this.formObject.containerSelector).find('.choice').remove();
}

PlugFormHandler.prototype.fillExpirationYearSelect = function (formText, method, value = null) {
    var html = '';
...
PlugFormHandler.prototype.fillExpirationMonthSelect = function (formText, method, value = null) {
    var html = '';
...
PlugFormHandler.prototype.removeMultibuyerForm = function (formObject) {
    jQuery(formObject.containerSelector + ' .multibuyer').remove();
    jQuery(formObject.containerSelector + ' .show_multibuyer_box').remove();
}

PlugFormHandler.prototype.toggleMultibuyer = function (formObject) {
