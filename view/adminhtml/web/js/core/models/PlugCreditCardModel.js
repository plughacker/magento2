define([
    ...
    "PlugHacker_PlugPagamentos/js/core/checkout/PlugListeners",
    "PlugHacker_PlugPagamentos/js/core/checkout/PlugCreditCardValidator",
], function (
    $,
    Class,
    alert,
    ...
    CreditCardModel.listenPaymentChange = function () {
        ...
        jQuery("#order-billing_method_form input.admin__control-radio").on("click", function(e){
            ...
            PlugAdmin.updateTotals("remove-tax", 0, amount);
        });
    };
    ...
    CreditCardModel.getCreditCardToken = function (success, error) {
        ...
        modelToken.getToken(this.clientId)
            .done(success)
            .fail(error);
    };
