...
namespace PlugHacker\PlugPagamentos\Ui\Component\Column;
...
{
    /** Url path */
    const URL_PATH_EDIT = 'plug/*/create';
    const URL_PATH_DELETE = 'plug/*/delete';
    /** @var UrlBuilder */
    ...
    {
        $actions[$name]['edit'] = [
            'href' => $this->getUrlPlug($type, $item, self::URL_PATH_EDIT),
            'label' => __('Edit')
        ];

        $actions[$name]['delete'] = [
            'href' => $this->getUrlPlug($type, $item, self::URL_PATH_DELETE),
            'label' => __('Delete'),
            'confirm' => [
    ...
    protected function getUrlPlug($type, $item, $path)
    {
