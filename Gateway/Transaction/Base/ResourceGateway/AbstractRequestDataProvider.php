<?php
namespace PlugHacker\PlugPagamentos\Gateway\Transaction\Base\ResourceGateway;
...
abstract class AbstractRequestDataProvider
{
    ...
    {
        return \PlugHacker\PlugPagamentos\Model\Enum\PersonTypeEnum::COMPANY;
    }
    ...
    public function getDocumentType()
    {
        ...
        return (strlen($identity) === 14) ?
            \PlugHacker\PlugPagamentos\Model\Enum\DocumentTypeEnum::CNPJ :
            \PlugHacker\PlugPagamentos\Model\Enum\DocumentTypeEnum::CPF;
    }
    ...
    {
        return \PlugHacker\PlugPagamentos\Model\Enum\CountryEnum::BRAZIL;
    }
    ...
    {
        $fromTo = [
            'VI' => \PlugHacker\PlugPagamentos\Model\Enum\CreditCardBrandEnum::VISA,
            'MC' => \PlugHacker\PlugPagamentos\Model\Enum\CreditCardBrandEnum::MASTERCARD,
            'AE' => \PlugHacker\PlugPagamentos\Model\Enum\CreditCardBrandEnum::AMEX,
            'DI' => \PlugHacker\PlugPagamentos\Model\Enum\CreditCardBrandEnum::DISCOVER,
            'DN' => \PlugHacker\PlugPagamentos\Model\Enum\CreditCardBrandEnum::DINERS,
        ];
